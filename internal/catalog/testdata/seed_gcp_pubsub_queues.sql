-- Minimal messaging.queue seed for GCP Pub/Sub LookupMessagingQueue unit tests.
...
INSERT INTO metadata VALUES
  ...
  ('shard','gcp-pubsub-queues'),
  ('allowed_kinds','["messaging.queue"]'),
  ('serving_providers','["gcp"]');

-- terms_hash for (on_demand,'','','','','') = 4b0dbf5efbd01c9e5f0a3f2e39227bc3
INSERT INTO skus VALUES
  ('PUBSUB-BASIC-GLOBAL','gcp','pubsub-queues','messaging.queue','throughput','global','global','4b0dbf5efbd01c9e5f0a3f2e39227bc3');
