-- Minimal warehouse.query seed for LookupWarehouseQuery unit tests.
...
-- terms_hash for (on_demand,'shared','on-demand','','','')                  = e6c83515dba83039119eb544e57c738c
-- terms_hash for (on_demand,'shared','on-demand','standard','','')          = 81cf901dbd1259c1e50765e3c44ac691
-- terms_hash for (on_demand,'shared','on-demand','enterprise','','')        = a4cf861ad60357ba572768cb94016da2
-- terms_hash for (on_demand,'shared','on-demand','enterprise-plus','','')   = 6ed36e1a710f001c15ba2b59f680331e
-- terms_hash for (on_demand,'shared','on-demand','storage-active','','')    = 46591a08149eb449a4268343bd6b6ec6
-- terms_hash for (on_demand,'shared','on-demand','storage-long-term','','') = f4c40f99e8dbadcd2f8b763baab86f27
INSERT INTO skus VALUES
  ('bq-od-bq-us',      'gcp', 'bigquery', 'warehouse.query', 'on-demand',                'bq-us', 'bq-us', 'e6c83515dba83039119eb544e57c738c'),
  ('bq-cap-std-bq-us', 'gcp', 'bigquery', 'warehouse.query', 'capacity-standard',        'bq-us', 'bq-us', '81cf901dbd1259c1e50765e3c44ac691'),
  ('bq-cap-ent-bq-us', 'gcp', 'bigquery', 'warehouse.query', 'capacity-enterprise',      'bq-us', 'bq-us', 'a4cf861ad60357ba572768cb94016da2'),
  ('bq-cap-ep-bq-us',  'gcp', 'bigquery', 'warehouse.query', 'capacity-enterprise-plus', 'bq-us', 'bq-us', '6ed36e1a710f001c15ba2b59f680331e'),
  ('bq-st-act-bq-us',  'gcp', 'bigquery', 'warehouse.query', 'storage-active',           'bq-us', 'bq-us', '46591a08149eb449a4268343bd6b6ec6'),
  ('bq-st-lt-bq-us',   'gcp', 'bigquery', 'warehouse.query', 'storage-long-term',        'bq-us', 'bq-us', 'f4c40f99e8dbadcd2f8b763baab86f27');
