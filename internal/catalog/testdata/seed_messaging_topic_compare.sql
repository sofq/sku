-- Minimal messaging.topic seed for QueryMessagingTopic compare tests.
-- Two rows: standard (mode=standard) and premium (mode=premium).
-- Used by internal/compare/kinds/messaging_topic_test.go.
...
INSERT INTO skus VALUES
  ('sns-standard-use1', 'aws','sns','messaging.topic','standard','us-east-1','us-east','hash-std'),
  ('sns-premium-use1',  'aws','sns','messaging.topic','premium', 'us-east-1','us-east','hash-prem');

INSERT INTO terms (sku_id, commitment, tenancy, os) VALUES
  ('sns-standard-use1', 'on_demand','',''),
  ('sns-premium-use1',  'on_demand','','');

INSERT INTO resource_attrs (sku_id, extra) VALUES
  ('sns-standard-use1', '{"mode":"standard"}'),
  ('sns-premium-use1',  '{"mode":"premium"}');

INSERT INTO prices VALUES
  ('sns-standard-use1', 'request','','',0.0000005,'1M-req'),
  ('sns-premium-use1',  'request','','',0.0000009,'1M-req');
