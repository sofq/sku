-- Minimal messaging.queue seed for LookupMessagingQueue unit tests.
...
INSERT INTO skus VALUES
  ('sqs-standard-use1', 'aws','sqs','messaging.queue','standard','us-east-1','us-east','4b0dbf5efbd01c9e5f0a3f2e39227bc3'),
  ('sqs-fifo-use1',     'aws','sqs','messaging.queue','fifo',    'us-east-1','us-east','4b0dbf5efbd01c9e5f0a3f2e39227bc3');
...
INSERT INTO resource_attrs (sku_id, extra) VALUES
  ('sqs-standard-use1', '{"queue_type":"standard"}'),
  ('sqs-fifo-use1',     '{"queue_type":"fifo"}');

INSERT INTO prices VALUES
  ('sqs-standard-use1', 'request','', 0.0000004, 'request'),
  ('sqs-fifo-use1',     'request','', 0.0000005, 'request');
