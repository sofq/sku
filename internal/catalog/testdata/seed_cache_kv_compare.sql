-- Minimal cache.kv seed for QueryCacheKV compare tests.
...
-- For MemoryGB=16, window is [16*0.9, 16*1.5] = [14.4, 24.0]
-- r6g.large at 15 GB is IN window
-- r6g.xlarge at 26 GB is OUT of window
INSERT INTO skus VALUES
  ...
  ('ec-r6g-xlarge-redis-use1',   'aws','elasticache','cache.kv','cache.r6g.xlarge', 'us-east-1','us-east','da12688b4e48d4af5da1db4ca7cf2ac0');
...
INSERT INTO terms (sku_id, commitment, tenancy, os) VALUES
  ...
  ('ec-r6g-xlarge-redis-use1',   'on_demand','redis','');

-- r6g.large = 15 GB (in [14.4, 24.0] window)
-- r6g.xlarge = 26 GB (out of window, > 24.0)
INSERT INTO resource_attrs (sku_id, memory_gb, extra) VALUES
  ('ec-r6g-large-redis-use1',    15.0, '{"engine":"redis"}'),
  ('ec-r6g-large-memcd-use1',    15.0, '{"engine":"memcached"}'),
