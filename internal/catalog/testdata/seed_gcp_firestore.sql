-- Minimal seed for LookupNoSQLDB unit tests against GCP Firestore data.
-- One native-mode row for us-east1 with four price dimensions.
-- terms_hash for on_demand|firestore-native|||| = e93559b61d8406ad8380178308856e1d
...
INSERT INTO metadata VALUES
  ...
  ('source_url','https://cloudbilling.googleapis.com/v1/services/EE2C-7FAC-5E08/skus'),
  ('shard','gcp-firestore'),
  ('allowed_kinds','["db.nosql"]'),
  ('serving_providers','["gcp"]');

INSERT INTO skus VALUES
  ('FIRESTORE-NATIVE-us-east1', 'gcp', 'firestore', 'db.nosql', 'native', 'us-east1', 'us-east', 'e93559b61d8406ad8380178308856e1d');

INSERT INTO terms VALUES
  ('FIRESTORE-NATIVE-us-east1', 'on_demand', 'firestore-native', '', '', '', '');

INSERT INTO resource_attrs (sku_id, extra) VALUES
  ('FIRESTORE-NATIVE-us-east1', '{"mode":"native"}');

INSERT INTO prices VALUES
  ('FIRESTORE-NATIVE-us-east1', 'storage',         '', '', 0.135,   'gb-mo'),
  ('FIRESTORE-NATIVE-us-east1', 'document_read',   '', '', 3.3e-07, 'request'),
  ('FIRESTORE-NATIVE-us-east1', 'document_write',  '', '', 1.8e-06, 'request'),
  ('FIRESTORE-NATIVE-us-east1', 'document_delete', '', '', 1.0e-07, 'request');
