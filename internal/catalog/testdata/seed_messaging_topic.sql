-- Minimal messaging.topic seed for LookupMessagingTopic unit tests.
...
INSERT INTO skus VALUES
  ('sns-standard-use1',  'aws','sns','messaging.topic','standard', 'us-east-1','us-east','4b0dbf5efbd01c9e5f0a3f2e39227bc3'),
  ('sns-standard-euw1',  'aws','sns','messaging.topic','standard', 'eu-west-1','eu-west','4b0dbf5efbd01c9e5f0a3f2e39227bc3');

INSERT INTO terms (sku_id, commitment, tenancy, os) VALUES
  ('sns-standard-use1',  'on_demand','',''),
  ('sns-standard-euw1',  'on_demand','','');

INSERT INTO resource_attrs (sku_id, extra) VALUES
  ('sns-standard-use1',  '{"protocol":"all"}'),
