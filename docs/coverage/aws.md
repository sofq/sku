...
| --- | ---: | --- | ---: | --- | --- |
| Compute Instance | 106,342 | aws_ec2 | 100% | availabilityzone, capacitystatus, classicnetworkingsupport, clockSpeed, currentGeneration, dedicatedEbsThroughput, +33 more | `DBCQPZ6Z853WRE98`, `QUMEF4UK3NPT4MN3`, `PSKQUF3DN4PQUY5X` |
| Compute Instance (bare metal) | 13,205 | **UNCOVERED** | — | availabilityzone, capacitystatus, classicnetworkingsupport, clockSpeed, currentGeneration, dedicatedEbsThroughput, +32 more | `TNWBCS5ACPZ2KN5K`, `PKKXPZKDGX8TTETG`, `9ZNF8HF7HCD62DUE` |
| Database Instance | 5,475 | aws_rds | 100% | clockSpeed, currentGeneration, databaseEdition, databaseEngine, dedicatedEbsThroughput, deploymentModel, +25 more | `AS89MVW9EQ98NPCS`, `9QH3PUGXCYKNCYPB`, `JVWTSDMM7WBJEBEV` |
| Serverless | 518 | aws_lambda | 100% | group, groupDescription, lambdaManagedInstanceType, lambdaManagedInstances-RequestType, location, locationType, +5 more | `8MV6QCXGTMB3SQSA`, `8VMHUU6HBE25BH4E`, `3DQDA3PNUY939FRS` |
| (no productFamily) | 276 | **UNCOVERED** | — | feeCode, feeDescription, fromLocation, fromLocationType, fromRegionCode, group, +14 more | `SG7CKZDA3VUU22WX`, `Z8X7XRC6YMB3B8CX`, `UMHS42HQRXCX35Z3` |
| Database Storage | 272 | **UNCOVERED** | — | databaseEdition, databaseEngine, deploymentModel, deploymentOption, engineCode, group, +14 more | `TYAUEGUCCZJVV7J5`, `QBY7T7A4DFW89EFJ`, `9N8GA2WTNXBZXF6T` |
| Dedicated Host | 254 | **UNCOVERED** | — | availabilityzone, capacitystatus, classicnetworkingsupport, clockSpeed, currentGeneration, ecu, +42 more | `SWYFQY6RNJ6NCDEE`, `US76PBRY3DCZYN6N`, `GUSF94EQ4ATETPFP` |
| Provisioned IOPS | 181 | **UNCOVERED** | — | databaseEdition, databaseEngine, deploymentModel, deploymentOption, engineCode, group, +11 more | `HZNNAFUGB668T2AB`, `R9DARCTNKSGFJ38T`, `CSJDFDAZPE4BE5BD` |
...
| Provisioned Throughput | 62 | **UNCOVERED** | — | databaseEdition, databaseEngine, deploymentModel, deploymentOption, engineCode, group, +10 more | `S9UF7GMSRKG5ZGXY`, `7TQTD99Y2SEGAXHP`, `W89M6AG9NJ5S4YEF` |
| Performance Insights | 52 | **UNCOVERED** | — | databaseEngine, engineCode, group, groupDescription, instanceTypeFamily, location, +6 more | `27HUFMH8U28DFE4X`, `KZ4WTWHJMFEQZJJR`, `SJFEY7WSZ5H6CK52` |
...
| Storage Snapshot | 40 | **UNCOVERED** | — | databaseEdition, databaseEngine, deploymentModel, deploymentOption, engineCode, engineMediaType, +9 more | `FJBXDXSNQ7XGXNKR`, `B2XDPTNXCRU552G7`, `EWNJUQ4BXM8XM9BT` |
| (no productFamily) | 34 | **UNCOVERED** | — | databaseEngine, engineCode, engineMajorVersion, extendedSupportPricingYear, group, groupDescription, +7 more | `RMEDM9YAEZ5RRW4J`, `28U5G3XN9865JMQT`, `87SRGTAEQNFPCQPU` |
...
| API Request | 33 | aws_s3 | 100% | group, groupDescription, location, locationType, operation, regionCode, +3 more | `26TUJV6FNGAN44UY`, `GWU4HUHFNSRYMYNK`, `2C7JEQ54QWYYWGZ6` |
...
| CPU Credits | 24 | **UNCOVERED** | — | databaseEngine, engineCode, instanceFamily, location, locationType, operation, +4 more | `UVZ2F6FPTBMGJ35R`, `PE7V3XVMH945XXTB`, `ECACTGY58DJ2HQB8` |
...
| System Operation | 18 | **UNCOVERED** | — | databaseEngine, engineCode, group, groupDescription, limitlesspreview, location, +7 more | `5Z2UYT8WXMZGM6EY`, `SHATDUXG5H8C5N35`, `A2DPEC4HNY3TS286` |
| Storage | 17 | aws_s3 | 100% | availability, durability, location, locationType, operation, overhead, +6 more | `G76SDFUV63NSS6N2`, `2N3NKSP5AF8HYTS2`, `EXB3YJ6YV5CRH4JN` |
...
| Amazon DynamoDB PayPerRequest Throughput | 10 | aws_dynamodb | 100% | group, groupDescription, location, locationType, operation, regionCode, +4 more | `W8ERENBEK6BZJAWC`, `FGXVD96DKJMUASY3`, `MJVXP493BSJ5SKSQ` |
| RDSProxy | 8 | **UNCOVERED** | — | acu, databaseEngine, engineCode, location, locationType, operation, +5 more | `AHVT2C6WP2BB5BXQ`, `FRAHVUJVSQ9JH49R`, `746KK4645QA9UP4N` |
...
| CPU Credits | 6 | **UNCOVERED** | — | instance, instanceFamilyCategory, location, locationType, marketoption, operatingSystem, +5 more | `3XWHFAKQQFKM4JSY`, `ZA9GXD8U7NKKZHC8`, `DHXM9J4FT38HQAQ6` |
...
| ServerlessV2 | 4 | **UNCOVERED** | — | databaseEngine, engineCode, location, locationType, operation, regionCode, +4 more | `KG668U3YXJQ6YH9Y`, `TP8SQX8FAU6UNY5B`, `AVKW7ZJP8D72HNQC` |
...
| DDB-Operation-ReplicatedWrite | 2 | **UNCOVERED** | — | group, groupDescription, location, locationType, operation, regionCode, +3 more | `MNQBR5JKF47TW9TE`, `QM7WV2JADZJDV45W` |
...
| Application Status Check | 1 | **UNCOVERED** | — | location, locationType, operation, regionCode, servicecode, servicename, +1 more | `US82U6F2YQD376DZ` |
