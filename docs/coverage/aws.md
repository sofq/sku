...
| Database Instance | 5,475 | aws_rds | 100% | clockSpeed, currentGeneration, databaseEdition, databaseEngine, dedicatedEbsThroughput, deploymentModel, +25 more | `2C3CJPFWMUWQ5WT4`, `AS89MVW9EQ98NPCS`, `9ZW3CAY6PP4NVFW2` |
| Serverless | 552 | aws_lambda | 100% | group, groupDescription, lambdaManagedInstanceType, lambdaManagedInstances-RequestType, location, locationType, +5 more | `PMC9N5C923BP22G8`, `Q6YHHV6NT43QBMQY`, `8MV6QCXGTMB3SQSA` |
| (no productFamily) | 276 | **UNCOVERED** | — | feeCode, feeDescription, fromLocation, fromLocationType, fromRegionCode, group, +14 more | `Z8X7XRC6YMB3B8CX`, `SG7CKZDA3VUU22WX`, `TH43ZXH75AC5F7PY` |
