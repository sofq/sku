...
| --- | ---: | --- | ---: | --- | --- |
| Compute Instance | 107,022 | aws_ec2 | 100% | availabilityzone, capacitystatus, classicnetworkingsupport, clockSpeed, currentGeneration, dedicatedEbsThroughput, +33 more | `QUMEF4UK3NPT4MN3`, `DBCQPZ6Z853WRE98`, `PSKQUF3DN4PQUY5X` |
| Compute Instance (bare metal) | 13,273 | **UNCOVERED** | — | availabilityzone, capacitystatus, classicnetworkingsupport, clockSpeed, currentGeneration, dedicatedEbsThroughput, +32 more | `TNWBCS5ACPZ2KN5K`, `PKKXPZKDGX8TTETG`, `9ZNF8HF7HCD62DUE` |
...
| Dedicated Host | 259 | **UNCOVERED** | — | availabilityzone, capacitystatus, classicnetworkingsupport, clockSpeed, currentGeneration, ecu, +42 more | `SWYFQY6RNJ6NCDEE`, `US76PBRY3DCZYN6N`, `GUSF94EQ4ATETPFP` |
