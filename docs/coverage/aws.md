...
| --- | ---: | --- | ---: | --- | --- |
| Compute Instance | 104,635 | aws_ec2 | 100% | availabilityzone, capacitystatus, classicnetworkingsupport, clockSpeed, currentGeneration, dedicatedEbsThroughput, +33 more | `DBCQPZ6Z853WRE98`, `QUMEF4UK3NPT4MN3`, `PSKQUF3DN4PQUY5X` |
| Compute Instance (bare metal) | 11,059 | **UNCOVERED** | — | availabilityzone, capacitystatus, classicnetworkingsupport, clockSpeed, currentGeneration, dedicatedEbsThroughput, +32 more | `TNWBCS5ACPZ2KN5K`, `PKKXPZKDGX8TTETG`, `9ZNF8HF7HCD62DUE` |
| Database Instance | 5,254 | aws_rds | 100% | clockSpeed, currentGeneration, databaseEdition, databaseEngine, dedicatedEbsThroughput, deploymentModel, +25 more | `AS89MVW9EQ98NPCS`, `9ZW3CAY6PP4NVFW2`, `9QH3PUGXCYKNCYPB` |
...
| Database Storage | 248 | **UNCOVERED** | — | databaseEdition, databaseEngine, deploymentModel, deploymentOption, engineCode, licenseModel, +12 more | `5CY9R54BDJWYJ22J`, `TYAUEGUCCZJVV7J5`, `657RUPPEV3YQSGDA` |
| Dedicated Host | 234 | **UNCOVERED** | — | availabilityzone, capacitystatus, classicnetworkingsupport, clockSpeed, currentGeneration, ecu, +42 more | `SWYFQY6RNJ6NCDEE`, `US76PBRY3DCZYN6N`, `GUSF94EQ4ATETPFP` |
| Provisioned IOPS | 163 | **UNCOVERED** | — | databaseEdition, databaseEngine, deploymentModel, deploymentOption, engineCode, group, +11 more | `HZNNAFUGB668T2AB`, `F229ZZAXFSU4MQ35`, `CSJDFDAZPE4BE5BD` |
...
| Provisioned Throughput | 56 | **UNCOVERED** | — | databaseEdition, databaseEngine, deploymentModel, deploymentOption, engineCode, group, +10 more | `ED9TKE4RUFPF5G5F`, `XY9WTPTPG3MUCTUV`, `S9UF7GMSRKG5ZGXY` |
...
| Storage Snapshot | 37 | **UNCOVERED** | — | databaseEdition, databaseEngine, deploymentModel, deploymentOption, engineCode, engineMediaType, +9 more | `FJBXDXSNQ7XGXNKR`, `B2XDPTNXCRU552G7`, `EWNJUQ4BXM8XM9BT` |
