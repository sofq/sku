...
| --- | ---: | --- | ---: | --- | --- |
| Compute Instance | 104,635 | aws_ec2 | 100% | availabilityzone, capacitystatus, classicnetworkingsupport, clockSpeed, currentGeneration, dedicatedEbsThroughput, +33 more | `QUMEF4UK3NPT4MN3`, `DBCQPZ6Z853WRE98`, `PSKQUF3DN4PQUY5X` |
...
| Database Instance | 5,134 | aws_rds | 100% | clockSpeed, currentGeneration, databaseEdition, databaseEngine, dedicatedEbsThroughput, deploymentModel, +25 more | `AS89MVW9EQ98NPCS`, `9QH3PUGXCYKNCYPB`, `9TUPTR977JMXWRWK` |
