...
| --- | ---: | --- | ---: | --- | --- |
| Virtual Machines / Virtual Machines | 685 | azure_vm | 100% | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `Standard_D14`, `Standard_D4as_v7`, `Standard_D2a_v4` |
| Storage / Storage | 59 | azure_blob | 100% | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | ``, `Premium_SSD_Managed_Disks_P80`, `Cold` |
| Foundry Models / Foundry Models | 29 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `54 pro Batch inp Dz`, `Grok 7 Inp glbl`, `gpt-realtime-2 Image cd inp Gl` |
...
| Azure Database for PostgreSQL / Azure Database for PostgreSQL | 13 | azure_postgres | 100% | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `Standard_E64ds_v5`, `Standard_D16ads_v5`, `` |
...
| Microsoft Fabric / Microsoft Fabric | 7 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `Graph data science`, `RTI Event Listener and Alert`, `Fabric Meter 48` |
...
| Azure Cosmos DB / Azure Cosmos DB | 6 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `Azure Cosmos DB Materialized Views Builder D4s`, `Azure_Cosmos_DB_for_MongoDB_Worker_Node_32vCore`, `2 vCore - burstable` |
...
| Phone Numbers / Phone Numbers | 5 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `FR`, `CN`, `AR` |
