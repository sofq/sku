...
| Microsoft Fabric / Microsoft Fabric | 7 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `Eventhouse`, `BCDR Storage Cool`, `Fabric Meter 101` |
