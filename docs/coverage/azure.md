...
| Foundry Models / Foundry Models | 30 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `54 pro Batch inp Dz`, `Grok 7 Inp glbl`, `gpt-realtime-2 Image cd inp Gl` |
...
| Microsoft Fabric / Microsoft Fabric | 17 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `Graph data science`, `RTI Event Listener and Alert`, `Csms DB in MS Fabric` |
| Azure Database for PostgreSQL / Azure Database for PostgreSQL | 15 | azure_postgres | 100% | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `Standard_E64ds_v5`, `Standard_D16ads_v5`, `` |
