...
| --- | ---: | --- | ---: | --- | --- |
| Virtual Machines / Virtual Machines | 683 | azure_vm | 100% | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `Standard_E4-2as_v6`, `Standard_E64-16s_v5`, `Standard_E64-16ds_v4` |
...
| Foundry Models / Foundry Models | 30 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `54 opt Dz`, `gpt img 1.5 out img DZ`, `Grok 7 Inp DZone` |
| SQL Database / SQL Database | 23 | azure_sql | 100% | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `14 vCore`, `SQLDB_GP_Compute_Gen5_32`, `SQLDB_BC_Compute_Gen5_32` |
| Microsoft Fabric / Microsoft Fabric | 17 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `SQL database in Microsoft Fabric`, `Data Warehouse Accelerated`, `Eventhouse` |
| Azure Database for PostgreSQL / Azure Database for PostgreSQL | 15 | azure_postgres | 100% | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `2m vCore`, `Basic`, `AzureDB_PostgreSQL_Flexible_Server_General_Purpose_Ddsv4Series_Compute` |
| Foundry Tools / Foundry Tools | 14 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | ``, `Voice Live BYO Custom Speech Audio Input`, `Commitment Tier STT AddOn Azure 50K` |
...
| Azure App Service / Azure App Service | 12 | azure_functions | 100% | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | ``, `Azure_App_Service_Premium_v3_Plan_Linux_P3mv3`, `Azure_App_Service_Premium_v4_Plan_Linux_P5mv4` |
| PlayFab / PlayFab | 11 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `Consumption Extended`, `Consumption Standard` |
| Azure Database for MySQL / Azure Database for MySQL | 10 | azure_mysql | 100% | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `AzureDB_MySQL_General_Purpose_Compute_Gen5`, `AzureDB_MySQL_Flexible_Server_Confidential_Compute_ECadsv6_Series`, `Storage` |
| Cloud Services / Cloud Services | 10 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | ``, `Standard_G1`, `Standard_D13` |
...
| Azure Cosmos DB / Azure Cosmos DB | 6 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `2 vCore - burstable`, ``, `Azure Cosmos DB Materialized Views Builder D4s` |
...
| Azure Data Factory v2 / Azure Data Factory v2 | 1 | **UNCOVERED** | — | armRegionName, armSkuName, currencyCode, effectiveStartDate, isPrimaryMeterRegion, location, +16 more | `` |
